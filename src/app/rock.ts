...
class Rock extends Drawable {
    ...
    set angle(newAngle: number) {
        ...
        if (newAngle >= 0.0 && newAngle < Trigonometry.toRadians(20)) this._angle = Trigonometry.toRadians(20)
        else if (newAngle > Trigonometry.toRadians(360 - 20)) this._angle = Trigonometry.toRadians(360 - 20)
